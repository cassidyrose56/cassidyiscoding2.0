<script lang="ts">
    ...
    const updateGradients = () => {
      ...
      gsap.fromTo("#sm-tile", theme.b1, { ...theme.b2, duration: 6, ease: "none", repeat: -1, yoyo: true });
    }
  ...
  <div class="flex gap-2 bg-secondary-300 dark:bg-primary-900 justify-around items-center lg:col-span-2 md:col-span-3 h-fit w-fit lg:col-start-11 md:col-start-10 md:row-span-1 md:shadow-md rounded-lg md:p-4 absolute right-[32px] md:static">
